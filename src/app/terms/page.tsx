...
export const metadata = { title: "Terms of Service — HEADLINE.WORLD" };

export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service" updated="July 28, 2026">
      <P>
        These Terms of Service (“Terms”) govern your access to and use of HEADLINE.WORLD (the “Service”), operated by [Company Legal Name]
        (“HEADLINE.WORLD,” “we,” “us”). By creating an account or using the Service, you agree to these Terms. If you’re using
        HEADLINE.WORLD on behalf of a band, label, or management company, you’re agreeing on that organization’s behalf, and you
        confirm you have the authority to do so.
      </P>

      <H2>1. What HEADLINE.WORLD is</H2>
      <P>
        HEADLINE.WORLD is a workspace for touring musicians and the people who work with them — booking pipeline, contacts,
      ...
      <H2>2. Accounts</H2>
      <P>
        You need an account to use HEADLINE.WORLD. You’re responsible for the accuracy of the information you provide, for
      ...
      <P>
        HEADLINE.WORLD offers a free plan and paid subscription plans (currently Pro Artist, Touring Artist, and Management
      ...
      <P>You agree not to use HEADLINE.WORLD to:</P>
      <Ul>
      ...
      <P>
        You own the data you put into HEADLINE.WORLD — your bookings, contacts, contracts, financial records, and everything
      ...
      <P>
        HEADLINE.WORLD allows you to connect third-party services (for example Gmail, Google Calendar, Stripe, Square, Spotify
        for Artists, or Bandsintown). Connecting a service authorizes HEADLINE.WORLD to exchange the data necessary for that
      ...
      <P>
        HEADLINE.WORLD, its logo, and the software behind the Service are owned by us and protected by intellectual property
      ...
      <H2>9. Termination</H2>
      <P>
        You can stop using HEADLINE.WORLD and delete your account at any time. We may suspend or terminate your access if you
      ...
      <P>
        ...
        every requirement of your specific tour, venue, or business. HEADLINE.WORLD is a tool to help you run your business —
      ...
      <P>
        To the extent permitted by law, HEADLINE.WORLD and its team aren’t liable for indirect, incidental, or consequential
      ...
      <P>
        ...
        it takes effect. Continuing to use HEADLINE.WORLD after a change takes effect means you accept the updated Terms.
      </P>
