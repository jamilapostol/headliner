...
export const SITE_CONTENT_FIELDS: SiteContentField[] = [
  ...
  { key: "benefit_1_title", section: "Benefits", label: "1 — title", default: "Tour like you've got a team behind you" },
  {
    ...
    section: "Benefits",
    label: "1 — body",
    default: "Booking, routing, contracts and the money side in one place — so a solo artist runs their career at the same level as an act with a full crew.",
    multiline: true,
  },
  ...
  { key: "benefit_3_title", section: "Benefits", label: "3 — title", default: "Never leave money on the table" },
  {
    ...
    section: "Benefits",
    label: "3 — body",
    default: "Every guarantee and deposit tracked per show, so you know what you're still owed before you load out — not after tax season.",
    multiline: true,
  },
  ...
  { key: "feature_3_body", section: "Features", label: "3 — body", default: "Promoters, buyers, press, sponsors and hosts — with relationship strength, sortable lists and the date you last spoke.", multiline: true },
  { key: "feature_4_title", section: "Features", label: "4 — title", default: "Merch that counts itself" },
  { key: "feature_4_body", section: "Features", label: "4 — body", default: "Stock counts, cost and margin on every item — so you know what's in the trailer before you run out in Denver.", multiline: true },
  { key: "feature_5_title", section: "Features", label: "5 — title", default: "Money, tracked" },
  {
    key: "feature_5_body",
    section: "Features",
    label: "5 — body",
    default: "Income and expenses by category, with a receipt photo on every line — plus a running P&L and balance sheet. Tax-season ready.",
    multiline: true,
  },
