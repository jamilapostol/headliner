...
const TIERS: Array<{ key: PlanChoice; name: string; tagline: string; monthly: number; feats: string[]; popular?: boolean }> = [
  ...
  { key: "pro", name: "Pro Artist", tagline: "For working artists gigging every month.", monthly: 24, feats: ["Unlimited bookings", "Full CRM", "Merch inventory", "Financial hub", "Email campaigns (5k/mo)"] },
  { key: "touring", name: "Touring Artist", tagline: "For artists living on the road.", monthly: 59, popular: true, feats: ["Everything in Pro", "Tour routing + day sheets", "Roadie AI (200 actions/mo)", "Contracts", "3 team seats"] },
