...
const TIERS: Array<{ key: PlanChoice; name: string; tagline: string; monthly: number; feats: string[]; popular?: boolean }> = [
  ...
  { key: "pro", name: "Pro Artist", tagline: "For working artists gigging every month.", monthly: 24, feats: ["Unlimited bookings", "Full CRM + reminders", "Merch inventory", "Financial hub", "Email campaigns (5k/mo)"] },
  { key: "touring", name: "Touring Artist", tagline: "For artists living on the road.", monthly: 59, popular: true, feats: ["Everything in Pro", "Tour routing + day sheets", "Roadie AI (200 actions/mo)", "Contracts + e-sign", "3 team seats"] },
  { key: "team", name: "Management Team", tagline: "For managers running multiple artists.", monthly: 129, feats: ["Everything in Touring", "Roadie AI (500 actions/mo)", "Multi-artist workspaces", "Role-based permissions", "Accountant exports", "10 team seats"] },
];
