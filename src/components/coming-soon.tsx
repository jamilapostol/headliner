export function ComingSoon({ title, phase, description }: { title: string; phase: string; description: string }) {
  return (
    <div className="mx-auto max-w-[700px] px-4 py-5 sm:px-8 sm:py-7">
      <h1 className="mb-1 text-[22px] tracking-[-.02em] sm:text-[26px]">{title}</h1>
      <div className="mb-6 text-[13px] text-text/50">{description}</div>
      <div className="rounded-card border border-dashed border-text/15 bg-surface px-6 py-10 text-center">
        ...
        <div className="mx-auto mt-2 max-w-[380px] text-[13px] text-text/50">
