      ...
      <div className="grid grid-cols-1 items-start gap-3.5 lg:grid-cols-[1.5fr_1fr]">
        <div className="flex flex-col gap-3.5">
          <div className="overflow-x-auto rounded-card border border-border bg-surface">
            ...
            {campaigns.map((c) => (
              <div key={c.id} className="grid grid-cols-[2fr_1fr_1fr_1fr] items-center gap-2.5 border-b border-text/[.05] px-[18px] py-3 hover:bg-text/[.03]">
                <div>
                ...
                <div>
                  ...
                  <div className="text-[10px] text-text/35">OPEN</div>
                </div>
                <div>
                  <div className="font-mono text-[12.5px]">{Math.round(c.clickRate * 100)}%</div>
                  <div className="text-[10px] text-text/35">CLICK</div>
                </div>
                <div>
            ...
            {campaigns.length === 0 && <div className="px-[18px] py-7 text-center text-[13px] text-text/40">No campaigns sent yet.</div>}
            </div>
          </div>
          ...
          <div onClick={(e) => e.stopPropagation()} className="w-full max-w-[420px] rounded-2xl border border-border bg-surface p-6">
            ...
            >
              <label className="flex flex-col gap-1.5">
                <span className="text-[12px] font-medium text-text/50">Name</span>
                <input
                  name="name"
                  required
